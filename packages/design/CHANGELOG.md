...
- [#117](https://github.com/Misoto22/folio/pull/117) [`8e993c4`](https://github.com/Misoto22/folio/commit/8e993c4d7bb4fcb1f21485d7b352a4fc930dce90) Thanks [@Misoto22](https://github.com/Misoto22)! - `@misoto22/design` is now `@misoto22/folio`, and classes, `data-` attributes and custom properties move from `m22-` to `folio-`.
