...
const en = {
  ...
  agents: {
    ...
    skillsAdd: 'init writes the skill to .agents/skills/ — the path Codex, Cursor, Copilot, Gemini CLI, OpenCode, Cline, Zed and Warp share — and to .claude/skills/ when the project already has one. For any other agent, npx skills add Misoto22/folio finds it with no configuration.',
...
const zh: Messages = {
  ...
  agents: {
    ...
    skillsAdd: 'init 会把 skill 写到 .agents/skills/——Codex、Cursor、Copilot、Gemini CLI、OpenCode、Cline、Zed、Warp 共用这个路径——项目里已经有 .claude/ 时也写一份进去。其他 agent 用 npx skills add Misoto22/folio，不需要任何配置。',
    warningsTitle: '写错的时候',
