...
export const SURFACES_ZH: Record<string, ComponentCopyZh> = {
  article: {
    ...
    anatomy: [
      { hash: 'b3e69080', element: '正文栏', description: 'as 给什么就渲染什么——article、section 或 div——并打上 data-folio-article，article.css 里的每一条规则都限定在它上面。46rem 的行宽，自己不带任何行内外边距，所以父容器把它放哪它就在哪。' },
      ...
      { hash: '1a3df4d9', element: '超宽的块', description: 'figure、table 和 .folio-wide 是仅有的三样获准越出行宽的东西，因为六列的表格和一张有主体的图，在 46rem 下都读不成。' },
    ],
    practices: [
      ...
      ['adb8048f', '让管线把宽表格包进 .folio-table-scroll。表格本来就获准越出行宽，自己又没有可滚动的容器，所以八列顶开的是整个页面的横向滚动。'],
